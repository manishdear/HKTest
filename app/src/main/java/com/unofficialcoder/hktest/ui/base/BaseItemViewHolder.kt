...
import com.unofficialcoder.hktest.di.components.DaggerViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as HKTestApplication).applicationComponent)
