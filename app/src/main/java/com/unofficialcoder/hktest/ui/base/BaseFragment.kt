...
import com.unofficialcoder.hktest.di.DaggerFragmentComponent
import com.unofficialcoder.hktest.di.FragmentComponent
import com.unofficialcoder.hktest.di.FragmentModule
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as HKTestApplication).applicationComponent)
